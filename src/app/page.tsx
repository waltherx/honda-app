      ...
      <div className="container m-auto grid grid-cols-4 md:grid-cols-12">
        <main className="col-span-4 md:col-span-8">
          <div className="bg-base-200 rounded-s-lg shadow-sm sm:w-full">
            <div className="card bg-base-200 w-full">
              ...
              <div className="map__container card-body rounded-lg shadow-md z-0">
                {dataMoto ? (
                  <Mapa
                    device_id={dataMoto?.dispositivo?.id.toString() ?? "0"}
                  />
                ) : (
                  <MapaDefer />
                )}
        ...
        <aside className="col-span-4 ">
          <div className="h-screen bg-base-200 rounded-e-lg sticky top-0 p-2">
            <div className="max-w-xs mx-auto bg-base-100 rounded-lg shadow-md overflow-hidden mt-24">
              ...
              {dataMoto ? (
                <div className="px-4 py-3 sm:p-5">
                  ...
                  <div className="flex flex-col items-start justify-between mb-3">
                    ...
                    <span className="text-lg font-medium ">
                      {dataMoto.marca + ", " + dataMoto.modelo}
                    </span>
                  </div>
                  <div className="flex flex-col items-start justify-between mb-3">
                    <span className="text-sm font-medium text-gray-500">
                    ...
                    <div className="tooltip" data-tip="Ver dispositivo">
                      <Link
                        className="btn-md btn-ghost text-lg font-medium rounded-xl"
                        href={`/devices/positions/${dataMoto.dispositivo?.id}`}
                      >
                        {dataMoto.dispositivo?.serial}
                      </Link>
                    </div>
                  </div>
                  <div className="flex flex-row items-start justify-between mb-3">
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-lg font-medium ">
                        {toMoney(dataMoto.precio_compra)}
                      </span>
                    </div>
                  </div>
