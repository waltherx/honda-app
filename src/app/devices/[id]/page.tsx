...
const Page = ({ params, }: {
    ...
    const {
        ...
        isError,
        error,
        data: device } = useQuery<DeviceData, Error>({ queryKey: ['device', val], queryFn: () => getDeviceFn(val + "") });
                ...
                <div>
                    ...
                    <div>
                        <div className="card lg:card-side bg-base-100 shadow-xl">
                            <figure>
                                <QRCode className="card bg-white p-4 flex items-center justify-center"
                            ...
                            <div className="card-body">
                                ...
                                <p><b>Moto Id : </b>{device.moto_id ? device.moto_id : 'Disponible'}</p>
                            </div>
                        </div>
                    </div>
                </div>
