                            ...
                            <Tooltip direction="top" opacity={1} permanent>
                                <div className="relative max-w-xl">
                                    ...
                                    <div className="relative h-full border-2 border-base-100 rounded-lg bg-base-100 p-3">
                                        <div className="flex flex-col space-y-0 text-pretty">
                                            ...
                                            <div className="text-pretty italic">
                                                <p ><span className="font-semibold">Modelo: </span>{moto.modelo}</p>
                                                <p ><span className="font-semibold">Precio: </span>{toMoney(moto.precio_compra)}</p>
                                                <p ><span className="font-semibold">Fecha compra: </span>{toStr(moto.fecha_compra)}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
