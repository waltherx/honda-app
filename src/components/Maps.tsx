        ...
        >
          ...
          >
            <Tooltip direction="top" opacity={1} permanent>
              <span className="text-xs text-red-600 font-semibold shadow-md border-spacing-3 p-2">
                Fin
              </span>
            </Tooltip>
          </Marker>
          {positions.map((position, index, array) => (
            <>
              ...
              >
                <Tooltip direction="top" opacity={1} permanent>
                  <span className="text-xs font-semibold shadow-sm border-spacing-3 p-1">
                    {array.length - index}
                  </span>
                </Tooltip>
                <Popup>
          ...
          >
            <Tooltip direction="top" opacity={1} permanent>
              <span className="text-xs text-green-500 font-semibold shadow-md border-spacing-3 p-2">
                Inicio
              </span>
            </Tooltip>
          </Marker>
